  ...
  return (
    <div className="try-fortress-container">
      <div className="try-fortress-header">
        ...
        <p>
          Use nossas ferramentas financeiras agora mesmo e veja resultados reais
        </p>
      </div>
      ...
      <div className="tools-grid">
        <div className="tool-card">
          ...
          <button className="tool-button" onClick={() => navigate("/receipts")}>
            Usar Ferramenta
          </button>
        </div>
        ...
        <div className="tool-card">
          ...
          <button className="tool-button" onClick={() => navigate("/goals")}>
            Usar Ferramenta
          </button>
        </div>
      </div>
      ...
      <div className="save-section">
        ...
        <div className="save-buttons">
          ...
          <button
            ...
            onClick={() => alert("Relatório PDF disponível após registro")}
          >
