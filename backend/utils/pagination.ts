 ...
 */
export function getPaginationParams(query?: URLSearchParams): PaginationParams {
  if (!query) return { page: DEFAULT_PAGE, pageSize: DEFAULT_PAGE_SIZE };
 ...
 */
export function getPaginationMeta(totalCount: number, page: number, pageSize: number): PaginationMeta {
